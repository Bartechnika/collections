...
class CoronavirusLocalRestrictionsTest < ActionDispatch::IntegrationTest
  ...
  def then_i_enter_a_valid_english_postcode
    @area = "Tattooine"
    postcode = "E1 8QS"
    stub_coronavirus_area(postcode: postcode, name: @area)
  ...
  def then_i_enter_a_valid_english_postcode_with_a_future_level_two_restriction
    @area = "Naboo"
    postcode = "E1 8QS"
    stub_coronavirus_area(postcode: postcode,
                           name: @area,
  ...
  def then_i_enter_a_valid_english_postcode_with_an_extra_special_character
    ...
    stub_coronavirus_area(postcode: "E1 8QS", name: @area, current_alert_level: 2)
  ...
  def then_i_enter_a_valid_english_postcode_in_tier_two
    @area = "Coruscant Planetary Council"
    postcode = "E1 8QS"
    stub_coronavirus_area(postcode: postcode, name: @area, current_alert_level: 2)
  ...
  def then_i_enter_a_valid_english_postcode_in_tier_three
    @area = "Mandalore"
    postcode = "E1 8QS"
    stub_coronavirus_area(postcode: postcode, name: @area, current_alert_level: 3)
  ...
  def then_i_enter_a_valid_welsh_postcode
    postcode = "LL11 0BY"
    stub_coronavirus_area(postcode: postcode, country_name: "Wales")
  ...
  def then_i_enter_a_valid_scottish_postcode
    postcode = "G20 9SH"
    stub_coronavirus_area(postcode: postcode, country_name: "Scotland")
  ...
  def then_i_enter_a_valid_northern_ireland_postcode
    postcode = "BT48 7PX"
    stub_coronavirus_area(postcode: postcode, country_name: "Northern Ireland")
  ...
  def stub_coronavirus_area(postcode:,
                            name: "Tatooine",
    ...
    coronavirus_area = CoronavirusArea.new(gss, {
      "name" => name,
      "restrictions" => [current_restriction, future_restriction].compact,
    })
    CoronavirusArea.stubs(:find).with(gss).returns(coronavirus_area)
  end
end
